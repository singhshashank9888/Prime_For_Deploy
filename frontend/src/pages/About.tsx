...
const About = () => {
  ...
  useGSAP(() => {
    ...
    tl.fromTo(".about-breadcrumb", { opacity: 0, scale: 0.9, y: 20 }, { opacity: 1, scale: 1, y: 0, delay: 0.2 })
      .fromTo(".about-title", { opacity: 0, y: 40 }, { opacity: 1, y: 0 }, "-=0.8")
      .fromTo(".about-desc", { opacity: 0, y: 30 }, { opacity: 1, y: 0 }, "-=0.8");

    gsap.fromTo(".story-img", { opacity: 0, x: -60 }, {
      scrollTrigger: {
    ...
    gsap.fromTo(".story-content", { opacity: 0, x: 60 }, {
      scrollTrigger: {
        trigger: ".story-section",
        start: "top 85%",
        once: true,
    ...
    gsap.fromTo(".value-card", { opacity: 0, y: 50 }, {
      ...
      duration: 0.8,
      ease: "power2.out",
      onComplete: () => gsap.set(".value-card", { clearProps: "all" })
    });
  }, { scope: containerRef });

  return (
    <div ref={containerRef} className="bg-white text-slate-900 font-sans antialiased overflow-x-hidden">
      ...
      <section className="relative py-32 md:py-48 bg-white overflow-hidden text-center">
        ...
        <div className="relative container mx-auto px-6 z-10">
          ...
          <div className="about-breadcrumb inline-block px-4 py-1.5 mb-8 rounded-full bg-white/10 backdrop-blur-md border border-white/20">
          ...
          <h1 className="about-title text-5xl md:text-8xl font-bold text-white mb-8 tracking-tight drop-shadow-lg">
            Redefining <span className="font-light ">Healthcare</span>
          </h1>

          <p className="about-desc text-white/90 text-xl leading-relaxed max-w-2xl mx-auto drop-shadow-md backdrop-blur-[2px] py-2">
      ...
      <section className="story-section py-24">
        <div className="container mx-auto px-6 max-w-6xl">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
            <div className="story-img relative group">
        ...
        <div className="container mx-auto px-6 max-w-6xl">
          ...
          <div className="values-grid grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {values.map((v) => (
              <div
                key={v.title}
                className="value-card group bg-white p-10 rounded-[2rem] border border-slate-100 shadow-sm transition-all duration-500 hover:shadow-2xl hover:-translate-y-2"
              >
